...
import { FF_HOMEPAGE, FF_WORKSPACES } from "../../utils/feature-flags";
          ...
          {enabled && (
            ...
            >
              <Menu>
                ...
                {isFF(FF_WORKSPACES) && <Menu.Item label="Workspaces" to="/workspaces" icon={<IconGrid />} data-external exact />}
