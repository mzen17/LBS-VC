...
const ProjectName = ({
  name, setName, onSaveName, onSubmit, error, description, setDescription,
      ...
      {isFF(FF_WORKSPACES) ? (
        <div className="w-full flex flex-col gap-2">
          ...
          <Select
            ...
            value={workspace !== null ? String(workspace) : ""}
            onChange={(val) => setWorkspace(val ? parseInt(val) : null)}
